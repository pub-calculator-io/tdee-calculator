...
Use our accurate TDEE Calculator to determine your Total Daily Energy Expenditure. Discover how many calories you burn daily to reach your weight goals faster.
...
## Usage
* Add the shortcode `[calcio_tdee_calculator]` to your page, post or sidebar.
* Or add the following code: `<?php display_calcio_tdee_calculator(); ?>` to your template where you would like the TDEE Calculator to appear.
